...
デスクトップに住んでいるAIキャラクターを想像してみてほしい。何週間も前の会話を覚えていて、しばらく黙っていると気づいて話しかけてくる -- そんな存在を。

ELINOはElectronで作られたデスクトップコンパニオン。Live2DやVRMモデルをデスクトップ上に直接描画し、好きなLLMに接続し、あなたのことを覚え続ける。ブラウザタブの中のチャットボットじゃない。あなたのそばにいるもの。
...
**配信と一緒に** -- 配信モードでYouTubeやTwitchのチャットを読み取り、コンパニオンが視聴者と対話する。（開発中）
